...
///
/// The neutral spelling of the limit grammar's metric, in the order the grammar declares it. The
/// grammar itself — the field names, the serde shape, the validation — belongs to whoever parses
/// the configuration; only the chosen variant crosses into the crate that projects it.
...
pub struct GroupSpec {
    /// The group's name as the composition root interned it at boot, if it did. See
    /// [`GroupRuntime::lease_id`].
