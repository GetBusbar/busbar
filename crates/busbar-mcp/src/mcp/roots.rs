...
//! asked for roots mints state with a [`busbar_kernel::plane::approvals::DEFAULT_TTL_SECS`] window, and inside
...
//! [`busbar_kernel::plane::approvals::Rejected::StaleRoots`] — the caller restarts the exchange and answers
