...
pub(crate) fn gov_with_scopes(pairs: &[(&str, &str)]) -> busbar_contract::records::PlaneRequestCtx {
...
pub(crate) fn gov_with_key(
    ...
    let scopes = pairs
        ...
        .collect();
    busbar_contract::records::PlaneRequestCtx {
        key: Some(std::sync::Arc::new(busbar_contract::records::VirtualKey {
            id: id.to_string(),
            name: id.to_string(),
