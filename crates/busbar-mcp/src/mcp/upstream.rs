...
pub(crate) struct Authorised {
    ...
    /// [`busbar_contract::transport::transport::Transport::upstream_wire`] at the send site. Nothing between the two asks it
...
pub(crate) async fn call(
    ...
    *outcome = LegOutcome::Nothing;
    ...
    if !(200..300).contains(&response.status) {
        ...
        *outcome = LegOutcome::Failure(busbar_kernel::breaker::normalize_raw_error(
            &busbar_contract::upstream::RawUpstreamError::from_status(response.status),
