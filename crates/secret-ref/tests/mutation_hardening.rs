...
//! Mutation-hardening additions for `busbar-secret-ref`. The crate's existing suite in
//! `src/tests/lib_tests.rs` already covers its behavior; this file instead locks in the one
