...
use busbar_streams_codec::ir::{DecodeState, IrClientEvent};
...
/// are the quantities [`busbar_streams_codec::ir::usage::IrDuplexUsage`] does not carry and this plane must
