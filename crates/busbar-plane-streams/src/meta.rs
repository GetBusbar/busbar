...
/// against what [`busbar_streams_codec::ir::IrDuplexUsage`] actually reports.
...
/// this plane relays, carrying [`busbar_streams_codec::ir::codec::DecodeState::played_ms`]'s running total
