...
//! process — everything a [`busbar_contract::transport::wire::Conn`] cannot carry itself because it is a
...
/// The opaque handle this transport hands the kernel through [`busbar_contract::transport::wire::Conn::new`].
