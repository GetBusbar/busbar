...
impl CurrencyCode {
    ...
    /// million — the same [`crate::cost::NANOS_PER_CENT`] every 1.5.5 figure was projected through, and
    ...
    ///
    /// USD gives ten million, which is [`crate::cost::NANOS_PER_CENT`] exactly. JPY gives a billion — a
