...
use busbar_contract::caps::{Usage, UsageLine};
...
impl SettleFlag {
    ...
    #[must_use]
    pub fn posting_flag(self) -> busbar_contract::caps::PostingFlags {
        use busbar_contract::caps::PostingFlags as P;
        match self {
...
) -> busbar_contract::caps::PostingFlags {
    flags
        .into_iter()
        .fold(busbar_contract::caps::PostingFlags::NONE, |acc, f| {
