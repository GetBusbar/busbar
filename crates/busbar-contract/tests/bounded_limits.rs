...
use busbar_contract::bounded::{
    ArenaBytes, BoundedVec, FactValue, Facts, Labels, SlabBytes, Span, ARENA_BYTES,
    MAX_CURSOR_BYTES, MAX_KEYS, MAX_LEGS, MAX_LEG_REPLIES, MAX_NEEDMORE_FRAMES, MAX_RECORD_BYTES,
