...
//! excludes so the neutral source spells no protocol crate.
//!
...
//! plugin as a dev-dependency and constructs the cell directly. Named as `crate::handlers_chat_fixture::CHAT`
//! by the dispatch tests that hold a chat dispatch cell by value.
...
pub(crate) const CHAT: busbar_substrate::handlers::Op = busbar_substrate::handlers::frame(
