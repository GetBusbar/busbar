...
/// for the reason [`reverify`] does: the plane supplies only its fetch, and nothing above it is
/// per-plane. It REPLACED the background sweep job both planes used to run.
