...
async fn the_delegation_hop_lands_in_the_per_task_chain_naming_the_agent_it_was_issued_to() {
    ...
    crate::plane::taskstore::TASKS.set_sink(crate::plane::store::PlaneStoreView::narrow(sink.clone()));
    ...
    crate::plane::taskstore::TASKS
        .set_sink(crate::plane::store::PlaneStoreView::narrow(std::sync::Arc::new(busbar_store_memory::MemoryStore::new())));
}
