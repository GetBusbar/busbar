...
pub(crate) struct Caller<'a> {
    ...
    pub(crate) key: Option<&'a VirtualKey>,
...
pub(crate) struct Entitled<'i, I: CatalogueItem> {
    pub(crate) item: &'i I,
    pub(crate) fit: I::Fit,
}
...
pub(crate) fn judge<'i, I: CatalogueItem>(
    item: &'i I,
    caller: &Caller<'_>,
    query: &I::Query,
...
pub(crate) fn entitled<'i, I: CatalogueItem + 'i>(
...
pub(crate) fn rendered<'i, I: CatalogueItem + 'i>(
    items: impl IntoIterator<Item = &'i I>,
    caller: &Caller<'_>,
    query: &I::Query,
) -> Vec<I::Wire<'i>> {
