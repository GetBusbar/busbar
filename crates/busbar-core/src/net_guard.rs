...
impl GuardPolicy {
    ...
    pub(crate) fn plaintext_admissible(&self) -> bool {
...
pub(crate) fn split_url(url: &str) -> Result<(bool, String, u16, String), GuardRefusal> {
...
pub(crate) fn judge_host_name(host: &str, policy: GuardPolicy) -> Result<(), GuardRefusal> {
...
pub(crate) fn refuse_redirect(status: u16, location: Option<&str>) -> Result<(), GuardRefusal> {
...
pub(crate) fn refuse_oversized_body(
    url: &str,
    bytes: usize,
    policy: GuardPolicy,
) -> Result<(), GuardRefusal> {
