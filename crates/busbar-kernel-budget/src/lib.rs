...
pub struct AdmissionUnit<'r, S: CellStore> {
    ...
    parent_accrual_refused: Option<busbar_contract::caps::AccrualRefused>,
}
...
impl<'r, S: CellStore> AdmissionUnit<'r, S> {
    ...
    #[must_use]
    pub fn parent_accrual_refused(&self) -> Option<busbar_contract::caps::AccrualRefused> {
    ...
    pub fn spend(
        &self,
        hold: &mut busbar_contract::caps::Hold,
        chain: &BucketChain,
        amount: u64,
            ...
            Ok(grant) => {
                ...
                if let Some(cell) = self.parent {
                    match cell.accrue_child(principal, nanos, admit_token) {
                        ...
                        Err(busbar_contract::caps::AccrualRefused::ParentExited) => {}
