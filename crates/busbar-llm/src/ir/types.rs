...
//! The CONCRETE chat IR TYPES — request/response/stream structs + enums, split out of `ir/mod.rs`
//! at the G6 A4b dissolve so BOTH crates can `#[path]`-share one definition: busbar-llm's `ir/mod.rs`
