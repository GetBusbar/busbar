...
fn gemini_shim_key() -> &'static str {
    busbar_kernel::proto::array_stream_shim_key_for("gemini")
...
fn test_mid_stream_generic_detail_has_no_leak_markers() {
    ...
    let mut framer = busbar_kernel::proto::decl_for("gemini")
...
fn test_shim_strip_ordering_cross_protocol_keeps_model() {
    ...
    busbar_kernel::proto::decl_for(crate::proto_codec::PROTO_OPENAI)
        .and_then(|d| d.dialect())
