...
//! names nothing but `serde`. The RESOLUTION is "what does that mean to the loader" — it names
//! `FetchSpec`, `busbar_plugin_sign::TrustPolicy`, the embedded release key, the GitHub
//! release-asset URL convention, and the process ENVIRONMENT. Those are all facts about the plugin
//! subsystem, and none of them is a fact about config.
//!
