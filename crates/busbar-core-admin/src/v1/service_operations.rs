...
impl AdminService {
    ...
    pub(crate) async fn get_usage(
        ...
        for r in &rows {
            ...
            // of reach.
            //
            // TWO WAYS TO FALL BACK, and each is a statement rather than a convenience: no source
            // installed or no history resolved (a build with no root ledger in it), and a HOLE —
