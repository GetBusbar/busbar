...
use crate::trust::lane::BreakerQuery;
...
impl Candidate {
    ...
    #[must_use]
    pub fn lane(&self) -> Option<busbar_contract::caps::LaneId> {
        self.facts.lane()
    }
}
...
pub trait KindFacts {
    ...
    /// living in [`crate::trust::net`] as a free-standing library was a guard every carrier had to remember
    ...
    /// [`BreakerQuery::admits_lane`](crate::trust::lane::BreakerQuery::admits_lane), so the answer here and
