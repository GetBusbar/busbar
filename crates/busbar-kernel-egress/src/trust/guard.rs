...
impl RefusalKind {
    ...
    /// record.
    #[must_use]
    pub fn reason(self) -> busbar_contract::caps::ReasonCode {
        match self {
            RefusalKind::Permission => busbar_contract::caps::ReasonCode::PoolNotPermitted,
            RefusalKind::InvalidRequest => busbar_contract::caps::ReasonCode::NoRate,
        }
    }
}
