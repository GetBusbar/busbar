...
pub const PLANE_DECLARATION: busbar_contract::plane::PlaneDeclaration =
    busbar_contract::plane::PlaneDeclaration {
        key: "llm",
        // THE FALLBACK CATCH-ALL — every unclaimed path falls through to this plane, so a
        // kind-neutral layer reads the fallback key off this flag rather than a literal.
        fallback: true,
