...
use crate::dialect::{parse_sse_frame, write_sse_frame, SSE_DONE_FRAME, SSE_DONE_SENTINEL};
use busbar_contract::protocol::{
    find_frame_terminator, IrError, StreamTranslator, STREAM_ABORT_DETAIL,
};
...
pub struct StreamTranslate {
    ingress: Protocol,
    egress: Protocol,
    pub decode: crate::ir::StreamDecodeState,
    pub buf: Vec<u8>,
    ...
    #[cfg(test)]
    pub decode_calls: std::cell::Cell<usize>,
    ...
    #[cfg(test)]
    pub parse_calls: std::cell::Cell<usize>,
}
...
impl StreamTranslate {
    ...
    pub fn set_client_include_usage(&mut self, include: bool) {
    ...
    pub fn set_request_echo(&mut self, ingress_request_body: &serde_json::Value) {
            ...
            match find_frame_terminator(&self.buf[search_from..]) {
                Some((rel, term_len)) => {
                    ...
                    if self.same_proto
                        ...
                        && !matches!(
                            crate::dialect::sse_event_type(frame),
    ...
    /// `last_usage` field.
    pub fn usage(&self) -> Option<&crate::ir::IrUsage> {
...
pub fn response_to_ir_events(ir: &crate::ir::IrResponse) -> Vec<crate::ir::IrStreamEvent> {
...
fn rewrite_frame_strip_usage(frame: &[u8], data_str: &str) -> Vec<u8> {
    ...
    if let Some(stripped) = crate::dialect::strip_top_level_usage_member(data_str) {
