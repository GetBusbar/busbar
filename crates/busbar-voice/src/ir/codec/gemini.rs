...
//! shared voice IR that [`super::OpenAiRealtimeCodec`] targets. Design §1.4 / §2.6.
//!
...
/// Extract the split token classes from a Gemini `usageMetadata` object (§2.5 — audio vs text are
