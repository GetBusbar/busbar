...
// `busbar_kernel::telemetry` (they name no `App` and feed the recorder install that moved with
...
/// every plane names it (`busbar_kernel::telemetry::outcome_of`) for its own request-completion
