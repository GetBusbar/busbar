...
//! breath, settles per the settlement table and seals the end. Two callers hold a key to that cell:
//! this path, and the node's sweep. Whichever arrives second is told the unit is already settled,
//! and does nothing. There is no third.
//!
//! ## The one await
//!
