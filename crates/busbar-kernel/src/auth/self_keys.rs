...
/// held as [`Redacted`](busbar_contract::redacted::Redacted) so the struct's derived `Debug` cannot leak a LIVE
...
pub(crate) struct IssuedKey {
    pub(crate) secret: busbar_contract::redacted::Redacted<String>,
