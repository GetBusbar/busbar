...
//!
//! The DER walk this file used to own now lives in [`busbar_substrate::plane_host::spki`]: when the HOST owns an
...
//! spelling ([`spki_pin`]) and the host spelling ([`busbar_substrate::plane_host::spki::pin`]) are the SAME
