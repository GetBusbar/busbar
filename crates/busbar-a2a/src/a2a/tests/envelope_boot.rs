...
//! `busbar_kernel::` name that names the backing lives HERE, in this `tests/`-path file the
...
//! plane's shipped `src/testkit.rs` reaches no `busbar_kernel::` implementation item.
