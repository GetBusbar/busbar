...
fn a_key(id: &str, agents: Option<&[&str]>) -> busbar_contract::records::VirtualKey {
...
fn a_grant_for_one_agent_cannot_mint_against_a_registration_for_another() {
    ...
    reg.outbound_cred = Some(crate::a2a::creds::OutboundCredential {
        secret: busbar_contract::SecretRef::file(secret_file().to_string_lossy().to_string()),
...
fn a_lease(agent_id: &'static str, now_ms: u64) -> crate::a2a::creds::Lease {
    ...
    crate::a2a::creds::mint_from(
        ...
        &crate::a2a::creds::OutboundCredential {
            secret: busbar_contract::SecretRef::file(path.to_string_lossy().to_string()),
            placement: crate::a2a::creds::CredentialPlacement::AuthorizationHeader,
            lease_ttl_ms: 600_000,
        },
        resolver.as_ref(),
