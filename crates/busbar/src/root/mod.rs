...
// WHERE A RELAYED SESSION'S LEG IS DIALLED, under the SAME neutral switch and for the same reason.
// The driver is synchronous and cannot dial; this is the half that can, and it names no plane and no
