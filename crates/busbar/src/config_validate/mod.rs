...
/// The secret-reference walk. A COMPILER-ENFORCED exhaustive destructure of `RootCfg` — see that
/// module's header for why the previous hand-written list failed open, and for the precise
/// boundary of what the destructure can and cannot reach.
mod secret_refs;
