...
const PLANE_ROOTS: &[(&str, &str)] = &[
    ...
    ("streaming", "crates/busbar-streaming/src"),
];
...
const SINGLE_PLANE_ALLOWLIST: &[(&str, &str, &str)] = &[
    ...
    ("cost_close", "streaming", "Neutral single-consumer money-lease (MeteringHost reserve/settle): generic nanodollar signature, no voice-transport vocabulary; sole current caller is the voice D2 live-session lease (see F4 oracle)."),
    ...
    ("cost_reserve", "streaming", "Neutral single-consumer money-lease (MeteringHost reserve/settle): generic nanodollar signature, no voice-transport vocabulary; sole current caller is the voice D2 live-session lease (see F4 oracle)."),
    ("cost_settle", "streaming", "Neutral single-consumer money-lease (MeteringHost reserve/settle): generic nanodollar signature, no voice-transport vocabulary; sole current caller is the voice D2 live-session lease (see F4 oracle)."),
    ("cost_settled", "streaming", "Neutral single-consumer money-lease (MeteringHost reserve/settle): generic nanodollar signature, no voice-transport vocabulary; sole current caller is the voice D2 live-session lease (see F4 oracle)."),
    ...
    ("price_usage", "streaming", "Neutral single-consumer money-lease (MeteringHost reserve/settle): generic nanodollar signature, no voice-transport vocabulary; sole current caller is the voice D2 live-session lease (see F4 oracle)."),
