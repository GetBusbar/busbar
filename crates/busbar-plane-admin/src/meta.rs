...
/// closed 66+13 table collapses to two classes rather than one per verb: pricing is uniform across
...
/// 66+13-row `KernelVerb` table -- the admin SURFACE itself, not a plane's self-description of it.
...
///
/// Declaring this plane's OWN introspection verb as, say, `verb_table` (a verb that dumps the 66+13
...
/// copy of the same 84 rows rather than new information. Empty is the honest answer for a plane
