...
//! Dual-control posture and the operator-key ceremony gate, for the 13 new 1.6.0 verbs.
//!
...
pub fn check_dual_control(
    ...
    // Maker-checker is scoped to MUTATING verbs, and two of the thirteen are not: `verify` and
...
/// The full posture check for the 13 new verbs, run in the order the module doc names: operator
