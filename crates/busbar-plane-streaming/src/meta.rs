...
pub const OP_SESSION_OPEN: OpClassId = OpClassId::new("streaming.session.open");
...
pub const EGRESS_PACING_FACT_KEY: &str = "streaming.pacing.played_ms";
...
impl PlaneMeta for StreamingPlane {
    const KEY: &'static str = "streaming";
