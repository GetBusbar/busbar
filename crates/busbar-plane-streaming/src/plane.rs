...
impl Plane for StreamingPlane {
    ...
    fn content_facts<'u>(
        ...
        let mut facts = Facts::new();
        for key in <StreamingPlane as busbar_contract::plane::PlaneMeta>::CONTENT_FACTS {
...
impl SessionPlane for StreamingPlane {
...
fn upstream_dialect_for(plane: &StreamingPlane, dest: &VerifiedDestination) -> Dialect {
    match dest.facts() {
