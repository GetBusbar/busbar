...
use busbar_streaming_codec::ir::{DecodeState, IrClientEvent};
...
/// are the quantities [`busbar_streaming_codec::ir::usage::IrDuplexUsage`] does not carry and this plane must
