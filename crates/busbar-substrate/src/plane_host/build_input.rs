...
/// (`None` ⇒ [`LlmAuthStyle::Default`], the protocol's native auth). The plane maps this back to the
...
pub struct LlmHealthInput {
    /// The probing strategy.
    pub mode: LlmHealthMode,
...
pub struct LlmLaneInput {
    ...
    pub health: Option<LlmHealthInput>,
