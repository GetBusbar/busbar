# busbar 1.6.0 — the contract of the twelve new admin verbs (+ `amend_rate_history`)

**Status: DESIGN, for owner review. No handler is implemented against this document yet.**

Base: `keep-admin-17-verbs` (`da4179599`). Branch `admin-12-verbs`.
...
| verb | plane table today (`verbs.rs`) | this document | disposition |
|---|---|---|---|
