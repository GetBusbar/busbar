...
<!-- public-hygiene-lint: allow — security advisory Evidence section: names the exact commit that fixed and measured this issue, which a reader auditing the fix needs -->
