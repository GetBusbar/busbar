...
#
# STATUS: ready. Wired against the `busbar-streaming` plane. Each slice drives EVERY captured fixture in
# `testing/streaming-conformance/fixtures/$dialect/` through the dialect's real codec
