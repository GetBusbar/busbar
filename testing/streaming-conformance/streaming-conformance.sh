...
#   testing/streaming-conformance/fixtures/{openai,gemini}/   captured transcripts + spec fixtures
...
# is broken.
selftest() {
  say "== streaming-conformance SELF-TEST (the scaffold's accounting cannot be lied to) =="
