...
if ! result="$(jq -n \
  ...
  # to refuse. This is the HARNESS failing to assemble what it measured, not a cell this host
  # cannot host, so it gives up (harness_error, exit 70) instead of filing a gap.
