...
# shellcheck disable=SC2086
grep -rq 'name: busbar_plane_mcp::PLANE_KEY' $MCP_DECL_SRC \
  || die "the MCP protocol crates must build their ProtocolDecl over that key (name: busbar_plane_mcp::PLANE_KEY)"
