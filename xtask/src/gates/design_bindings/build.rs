...
const COMMENT: &[&str] = &[
    "GENERATED by `cargo xtask gate design-bindings --write`. Hand-added `checks` entries are preserved across regeneration;",
    ...
    "Checked by `cargo xtask gate design-bindings` (existence only; nothing is executed).",
];
...
pub fn render_md(doc: &J) -> String {
    ...
    let mut out: Vec<String> = vec![
        ...
        String::new(),
        "GENERATED by `cargo xtask gate design-bindings --write` from `docs/design/ARCHITECTURE.md` Appendix B. Do not edit by hand.".into(),
        String::new(),
        "One row per parity binding; `checks` lists what it CITES, and `verdict` says what those".into(),
        "citations actually earned (existence-checked by `cargo xtask gate design-bindings`; nothing".into(),
        "is executed).".into(),
        String::new(),
    ...
    if !unproven.is_empty() {
        out.extend([
            ...
            "red under `cargo xtask gate design-bindings`; it is fixed by making the citation real,".into(),
    ...
    out.extend([
        ...
        String::new(),
        "`cargo xtask gate design-bindings` proves existence only. The mapped kinds can be executed later by a slower tier:".into(),
        String::new(),
