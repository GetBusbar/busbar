...
mod tests {
    ...
    /// T10: THE DOOR. A legacy crate's deletion drops `gate.plane_crates` by one, and the ONLY
    /// thing that admits the drop is a row naming the crate, the commit, the floor and both
    /// numbers.
    #[test]
